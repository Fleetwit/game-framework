...
mazeEditor.prototype.canMove = function(vx,vy) {
	var canMove = true;
	if (vx == 1) {
		canMove = canMove && this.walls["v"][this.startpoint.x+1] && this.walls["v"][this.startpoint.x+1][this.startpoint.y] && !this.walls["v"][this.startpoint.x+1][this.startpoint.y].state;
	}
	if (vx == -1) {
		canMove = canMove && this.walls["v"][this.startpoint.x] && this.walls["v"][this.startpoint.x][this.startpoint.y] && !this.walls["v"][this.startpoint.x][this.startpoint.y].state;
	}
	if (vy == 1) {
		canMove = canMove && this.walls["h"][this.startpoint.x] && this.walls["h"][this.startpoint.x][this.startpoint.y+1] && !this.walls["h"][this.startpoint.x][this.startpoint.y+1].state;
	}
	if (vy == -1) {
		canMove = canMove && this.walls["h"][this.startpoint.x] && this.walls["h"][this.startpoint.x][this.startpoint.y] && !this.walls["h"][this.startpoint.x][this.startpoint.y].state;
	}
	return canMove;
};
